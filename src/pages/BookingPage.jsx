...
const APT_TYPES = [
  ...
  { value: '1br',    label: '1 Bedroom',  icon: '🛏',  desc: '~4 hrs' },
  { value: '2br',    label: '2 Bedrooms', icon: '🛏🛏', desc: '~6 hrs' },
  { value: '3br',    label: '3 Bedrooms', icon: '🏡',  desc: '~8 hrs' },
  { value: 'house',  label: 'House',      icon: '🏘',  desc: '~10 hrs' },
]
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              <div style={{ background: 'linear-gradient(135deg, #EFF6FF, #F5F3FF)', borderRadius: 14, padding: 16 }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13, color: '#6B7280', marginBottom: 4 }}>
                  <span>Labor ({form.movers_count} movers × {price.hours}hrs × ${price.rate}/hr)</span>
          ...
          {step === 3 && done && (
            <div style={{ textAlign: 'center', padding: '20px 0' }}>
              ...
              <div style={{
                ...
                <div style={{ fontWeight: 700, color: '#3B82F6', marginTop: 8 }}>Total: ${price.total}</div>
              </div>
            </div>
          )}
