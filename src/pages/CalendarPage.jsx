...
const STATUS = {
  new:         { dot:'#93C5FD', bg:'#EFF6FF', color:'#1E40AF', label:'New',         cardBg:'#F8FBFF', headerBg:'#3B82F6' },
  scheduled:   { dot:'#6EE7B7', bg:'#F0FDF4', color:'#065F46', label:'Scheduled',   cardBg:'#F6FEFA', headerBg:'#34D399' },
  in_progress: { dot:'#FCD34D', bg:'#FFFBEB', color:'#92400E', label:'In Progress', cardBg:'#FFFEF5', headerBg:'#FBBF24' },
  completed:   { dot:'#6EE7B7', bg:'#F0FDF4', color:'#065F46', label:'Completed',   cardBg:'#F6FEFA', headerBg:'#34D399' },
  cancelled:   { dot:'#CBD5E1', bg:'#F8FAFC', color:'#64748B', label:'Cancelled',   cardBg:'#FAFAFA', headerBg:'#CBD5E1' },
}
