    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <button onClick={prev} className="px-3 py-1.5 border border-gray-300 rounded-lg text-sm hover:bg-gray-50 transition-colors">← Пред</button>
          <button onClick={() => setCurrent(new Date())} className="px-3 py-1.5 border border-gray-300 rounded-lg text-sm hover:bg-gray-50 transition-colors">Сегодня</button>
          <button onClick={next} className="px-3 py-1.5 border border-gray-300 rounded-lg text-sm hover:bg-gray-50 transition-colors">След →</button>
        </div>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="space-y-0.5">
                  ...
                  {dayJobs.length > 2 && (
                    <div className="text-xs text-gray-400 px-1">+{dayJobs.length - 2} ещё</div>
                  )}
                </div>
              </div>
            )
