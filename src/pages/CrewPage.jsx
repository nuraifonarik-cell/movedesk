...
const ROLES = [
  { key:'foreman', label:'Foreman', icon:UserCheck, color:'#1D4ED8', bg:'#EFF6FF', headerBg:'#1E3A8A', dot:'#3B82F6' },
  { key:'helper',  label:'Helper',  icon:HardHat,  color:'#059669', bg:'#F0FDF4', headerBg:'#064E3B', dot:'#10B981' },
  { key:'driver',  label:'Driver',  icon:Truck,    color:'#D97706', bg:'#FFFBEB', headerBg:'#78350F', dot:'#F59E0B' },
]
