...
const ROLE_LABELS = { driver: 'Водитель', mover: 'Грузчик', lead: 'Старший' }
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-semibold text-gray-900">Бригада</h1>
        <span className="text-sm text-gray-400">{crew.length} сотрудников</span>
      </div>

      {loading ? (
        <div className="text-center text-sm text-gray-400 py-12">Загрузка...</div>
      ) : (
