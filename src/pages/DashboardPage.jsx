...
export default function DashboardPage() {
  ...
  const monthRevenue = jobs
    ...
    .reduce((s,j) => s + (parseFloat(j.actual_total ?? j.total_price ?? 0) || 0), 0)
  ...
  const stats = [
    ...
    { label:'Revenue / mo',value:`$${Math.round(monthRevenue).toLocaleString()}`, color:'#5B21B6', bg:'#EDE9FE', dot:'#7C3AED' },
  ]
