...
export default function JobDetailPage() {
  ...
  const assignCrew = async (removeId, addId, role) => {
    ...
    // No-op: removing and adding same person, or both null
                    ...
                    return (
                      <div>
                        ...
                        <select disabled={isLocked||crewLocked} value={curId}
                          onChange={e => { if (e.target.value !== curId) assignCrew(curId||null, e.target.value||null, 'foreman') }}
                  ...
                  {(() => {
                    ...
                    return (
                      <div>
                        ...
                        <select disabled={isLocked||crewLocked} value={curId}
                          onChange={e => { if (e.target.value !== curId) assignCrew(curId||null, e.target.value||null, 'driver') }}
