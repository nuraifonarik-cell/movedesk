...
export default function JobDetailPage() {
  ...
  return (
    <div style={{padding:20, fontFamily:"'Inter',system-ui,sans-serif", maxWidth:1000}}>
      ...
      {/* Edit / Delete buttons — only for new and scheduled */}
      {['new','scheduled'].includes(job.status) && (
        <div style={{display:'flex', gap:8, marginBottom:16}}>
          ...
          <button onClick={deleteJob} disabled={deleting}
            style={{display:'flex', alignItems:'center', gap:6, padding:'8px 16px', borderRadius:10, border:'1px solid #FECACA', background:'#FEF2F2', fontSize:13, fontWeight:600, color:'#DC2626', cursor:'pointer'}}>
