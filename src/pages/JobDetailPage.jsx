          ...
          <div style={card}>
            ...
            <div style={{display:'flex', flexDirection:'column', gap:8}}>
              <button onClick={() => navigate(`/jobs/${id}/contract`)}
                style={{display:'flex', alignItems:'center', gap:8, padding:'10px 14px', borderRadius:10, border:'0.5px solid #1D4ED8', background:'#EFF6FF', fontSize:13, color:'#1D4ED8', cursor:'pointer', fontWeight:700}}>
                <FileText size={14} color="#1D4ED8"/> Open Contract
              </button>
