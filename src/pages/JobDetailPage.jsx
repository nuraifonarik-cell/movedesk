                  ...
                  <div key={group.label}>
                    ...
                    <div style={{display:'flex', flexDirection:'column', gap:6}}>
                      {group.members.map((member, i) => {
                        ...
                        const isSaving  = crewSaving[member.id]
                        ...
                        return (
                          <div key={member.id} onClick={() => toggleCrew(member.id)}
                            style={{
                              ...
                              padding:'10px 14px', borderRadius:10, cursor: isSaving ? 'not-allowed' : 'pointer',
                              border:`1.5px solid ${assigned ? group.color : '#E2E8F0'}`,
                              background: assigned ? group.bg : 'white',
                            ...
                            {isSaving
                              ...
                              : assigned && <CheckCircle2 size={16} color={group.color}/>
                            }
                          </div>
                        )
                      })}
