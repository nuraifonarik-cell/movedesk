        ...
        <div style={{display:'flex',flexDirection:'column',gap:14}}>
          ...
          <div style={card}>
            ...
            {crew.length === 0
              ...
              : (
                <div style={{display:'flex',flexDirection:'column',gap:14}}>
                  {/* FOREMAN — single dropdown with "None" option */}
                  {(() => {
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={e => {
                            ...
                            if (newVal === curId) return
                            assignCrew(curId || null, newVal || null, 'foreman')
                          }}
                  ...
                  {/* DRIVER — single dropdown with "None" option */}
                  {(() => {
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={e => {
                            const newVal = e.target.value
                            if (newVal === curId) return
                            assignCrew(curId || null, newVal || null, 'driver')
                          }}
