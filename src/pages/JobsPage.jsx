...
const STATUS = {
  new:         { bg:'#DBEAFE', color:'#1E40AF', dot:'#3B82F6', rowBg:'#EFF6FF', label:'New' },
  quoted:      { bg:'#EDE9FE', color:'#5B21B6', dot:'#7C3AED', rowBg:'#F5F3FF', label:'Quoted' },
  scheduled:   { bg:'#D1FAE5', color:'#065F46', dot:'#10B981', rowBg:'#F0FDF4', label:'Scheduled' },
  in_progress: { bg:'#FEF3C7', color:'#92400E', dot:'#F59E0B', rowBg:'#FFFBEB', label:'In Progress' },
  completed:   { bg:'#D1FAE5', color:'#065F46', dot:'#059669', rowBg:'#ECFDF5', label:'Completed' },
  cancelled:   { bg:'#F1F5F9', color:'#64748B', dot:'#94A3B8', rowBg:'#F8FAFF', label:'Cancelled' },
}
        ...
        {loading ? (
          ...
          return (
            <Link key={job.id} to={`/jobs/${job.id}`}
              style={{ display:'flex', alignItems:'center', gap:12, padding:'12px 16px', borderBottom:'0.5px solid rgba(0,0,0,0.06)', textDecoration:'none', background:(STATUS[job.status]??STATUS.new).rowBg, transition:'filter 0.1s' }}
