...
const STATUS = {
  new:         { bg:'#DBEAFE', color:'#1E40AF', dot:'#3B82F6', border:'#3B82F6', label:'New' },
  quoted:      { bg:'#EDE9FE', color:'#5B21B6', dot:'#7C3AED', border:'#7C3AED', label:'Quoted' },
  scheduled:   { bg:'#D1FAE5', color:'#065F46', dot:'#10B981', border:'#10B981', label:'Scheduled' },
  in_progress: { bg:'#FEF3C7', color:'#92400E', dot:'#F59E0B', border:'#F59E0B', label:'In Progress' },
  completed:   { bg:'#D1FAE5', color:'#065F46', dot:'#059669', border:'#059669', label:'Completed' },
  cancelled:   { bg:'#F1F5F9', color:'#64748B', dot:'#94A3B8', border:'#CBD5E1', label:'Cancelled' },
}
        ...
        {loading ? (
          ...
          return (
            <Link key={job.id} to={`/jobs/${job.id}`}
              style={{ display:'flex', alignItems:'center', gap:12, padding:'12px 16px', borderBottom:'0.5px solid #F8FAFF', textDecoration:'none', borderLeft:`4px solid ${(STATUS[job.status]??STATUS.new).border}`, transition:'background 0.1s' }}
              ...
              <div style={{ flex:1, minWidth:0 }}>
                <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:3 }}>
                  ...
                  <span style={{ fontSize:11, fontWeight:700, padding:'3px 10px', borderRadius:20, background:s.bg, color:s.color, flexShrink:0, display:'inline-flex', alignItems:'center', gap:4 }}>
