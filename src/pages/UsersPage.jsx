          ...
          <div style={{ background:'white', borderRadius:20, padding:28, width:'100%', maxWidth:440, boxShadow:'0 20px 60px rgba(0,0,0,0.2)', maxHeight:'92dvh', overflowY:'auto' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
              ...
              <div>
                ...
                <input type="text" value={form.password} onChange={e=>set('password',e.target.value)} placeholder="Set their password" style={inp}/>
                <div style={{ fontSize:11, color:'#94A3B8', marginTop:4 }}>A welcome email with login credentials will be sent automatically.</div>
              </div>
            </div>
